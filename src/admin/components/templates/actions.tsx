  ...
  const actions = [
    {
      ...
      description: "Some orders need you to create a fulfillment",
      Icon: SquaresPlus,
    ...
    },
    {
      ...
      description: "Some orders need you to ship the items",
      Icon: FlyingBox,
    ...
    },
    {
      ...
      description: "Some orders need you to process returns",
      Icon: ArrowUturnLeft,
    ...
    },
    {
      ...
      description: "Some orders need you to handle swaps",
      Icon: ArrowPath,
